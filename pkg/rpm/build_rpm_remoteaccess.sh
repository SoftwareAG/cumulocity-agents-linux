...
touch %{buildroot}/usr/lib/systemd/system/cumulocity-remoteaccess.service
...
sed -r -e 's#[$]PREFIX#'"$PREFIX"'#g' ${SRC_ROOT}/utils/cumulocity-remoteaccess.service> %{buildroot}/usr/lib/systemd/system/cumulocity-remoteaccess.service
...
systemctl enable cumulocity-remoteaccess
...
/usr/lib/systemd/system/cumulocity-remoteaccess.service
